...
#define i2c_write   mpu_write_regs
#define i2c_read    mpu_read_regs
...
unsigned char mpu_write_regs(unsigned char dev_add , unsigned char reg, unsigned char num, unsigned char *dat)
{
		unsigned char i;
		simiic_start();
...
unsigned char mpu_read_regs(unsigned char dev_add , unsigned char reg, unsigned char num, unsigned char *dat_add)
{
	#define ack 1
	#define no_ack 0
